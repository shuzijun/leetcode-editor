package com.shuzijun.leetcode.platform.utils;
...
public class VelocityTool extends StringUtils {
     ...
     * @return
     */
    public static String SUBMIT_REGION_BEGIN(Config config) {
     ...
     * @return
     */
    public static String SUBMIT_REGION_END(Config config) {
        String codeType = config.getCodeType();
        CodeTypeEnum codeTypeEnum = CodeTypeEnum.getCodeTypeEnum(codeType);
