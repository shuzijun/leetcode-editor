...
public class Graphql {
    ...
    public static GraphqlBuilder builder(RepositoryService repositoryService) {
        return new GraphqlBuilder(repositoryService);
    }
    ...
    public static class GraphqlBuilder {
        ...
        private GraphqlBuilder(RepositoryService repositoryService) {
            this.repositoryService = repositoryService;
            this.url = repositoryService.getUrlService().getLeetcodeGraphql();
        }
        ...
        public HttpResponse request() {
            return HttpRequest.builder(repositoryService.getHttpRequestService()).post(url, "application/json")
                    .body(build().generate())
