 ...
 * @author shuzijun
 */
public class SimpleNavigatorPanel extends NavigatorPanel {
    ...
    private SimpleNavigatorTable navigatorTable;
    ...
    public SimpleNavigatorPanel(ToolWindow toolWindow, Project project) {
        super(Boolean.TRUE, Boolean.TRUE);
        this.myProject = project;
        this.myNavigatorAction = createMyNavigatorAction();
        navigatorTable = new SimpleNavigatorTable(project, myNavigatorAction);
    ...
    private NavigatorAction<QuestionView> createMyNavigatorAction() {
        return new NavigatorAction.Adapter<QuestionView>() {
            ...
            public boolean position(String slug) {
                ...
                int targetPage = (questionIndex.getIndex() / navigatorTable.getPageInfo().getPageSize()) + 1;
                if (navigatorTable.getPageInfo().getPageIndex() == targetPage && selectedRow(slug)) {
                    LogUtils.navigatorTrace("position:already-visible slug=" + slug);
                    return true;
                }
                resetPositionFilters();
                navigatorTable.getPageInfo().setPageIndex(targetPage);
            ...
            private void resetPositionFilters() {
