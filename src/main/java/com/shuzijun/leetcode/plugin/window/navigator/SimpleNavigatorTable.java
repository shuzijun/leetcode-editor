...
public class SimpleNavigatorTable extends NavigatorTableData<QuestionView> {
    ...
    public SimpleNavigatorTable(Project project, NavigatorAction<QuestionView> navigatorAction) {
        super(project);
    ...
    protected JTextPane firstToolTip() {
        ...
        if (Locale.getDefault().getLanguage().equals(Locale.CHINESE.getLanguage())) {
            styleList = List.of(new MyStyle(5, 7, style));
        } else {
            styleList = List.of(new MyStyle(18, 22, style));
        }
    ...
    protected void setColumnWidth(MyJBTable<QuestionView> myJBTable) {
