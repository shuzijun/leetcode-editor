...
public class CodeServiceImpl implements CodeService {
    ...
    private String getCodeText(Question question, Config config, CodeTypeEnum codeTypeEnum, Project project) {
    ...
    public void SubmitCode(String titleSlug) {
        ...
        try {
            ...
            HttpResponse response = repositoryService.HttpRequest().post(URLUtils.getLeetcodeProblems() + question.getTitleSlug() + "/submit/", "application/json")
    ...
    public void RunCodeCode(String titleSlug) {
        ...
        try {
            ...
            arg.put("typed_code", code);
            HttpResponse response = repositoryService.HttpRequest().post(URLUtils.getLeetcodeProblems() + question.getTitleSlug() + "/interpret_solution/", "application/json")
                    .addHeader("Accept", "application/json").body(arg.toJSONString()).request();
            if (response.getStatusCode() == 200) {
